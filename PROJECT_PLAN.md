...
| 阶段 | 时间 | 第一人 | 第二人 | 交付物 |
|------|------|--------|--------|--------|
| 需求分析 | Day 1 | 确定网络架构 | 数据集分析 | `config.yaml`, 数据统计 |
| 数据准备 | Day 2-3 | - | 数据划分、增强实现 | train/val/test split文件 |
| 模型开发 | Day 4-6 | 模型+训练框架 | 完善DataLoader | `mobilenetv2_se.py`, `train.py` |
| 模型训练 | Day 7-12 | 训练循环、调优 | 辅助超参数测试 | `best_model.pth`, 训练日志 |
| 评估分析 | Day 13-15 | - | 指标计算、可视化 | `evaluation_report.md`, 图表 |
| 文档整理 | Day 16 | 模型设计文档 | 评估方法文档 | `PROJECT_REPORT.md` |
